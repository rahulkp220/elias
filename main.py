...
FILENAME = "EliasJacobson.pdf"

# threads and assistant id
assistant_id = "asst_VhC9zPOit8RyQTNGExV1YcGC"
thread_id = "thread_S3NHcqASs51WhWnoR1e0JVPy"
...
st.set_page_config(page_title="Chat with Elias!",
                   page_icon=":books:")
...
def upload_to_openai(filepath):
    with open(filepath, "rb") as file:
        response = client.files.create(
            file=(os.path.basename(filepath), file), purpose="assistants")
    return response.id
...
def process_message_with_citations(message):
    ...
    annotations = (
        message_content.annotations if hasattr(
...
st.title("Chat with Elias")
st.write("Upload data about Elias and be ready to talk to him!")
